    ...
    return (
        <div id='about' className='snap-start relative w-full h-screen flex flex-col md:flex-row items-center justify-center px-12 sm:px-16 md:px-24 lg:px-32 xl:px-32'>
            <div className='flex-1 flex flex-col gap-4 items-start justify-center'>
                ...
                <motion.div
                    className='mt-8 flex flex-row items-center justify-center gap-2 text-md sm:text-lg md:text-xl lg:text-2xl xl:text-3xl'
                    initial={{ opacity: 0, scale: 0.8, x: -200 }}
                    whileInView={{ opacity: 1, scale: 1, x: 0 }}
            ...
            <Image
                className='absolute bottom-0 right-0 mr-[-8rem] md:mr-[-6rem] lg:mr-[-4rem] -z-10'
